...
- Spans
  ...
  - Style them using different CSS rules; padding, border, margins, colors, backgrounds, fonts, text styles, etc
- Divs and semantic HTML5 elements
  ...
  - Give them a class or id where necessary
  - Style them using different CSS rules; padding, border, margins, colors, backgrounds, fonts, content alignment, round corners, etc
- Images
