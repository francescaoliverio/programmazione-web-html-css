...
- Create the following structure
  ...
  - In style.css apply styling to your HTML using many different properties [CSS Properties Reference](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Properties_Reference)
- Result
